      ...
      <ul className="list-unstyled ps-0">
        ...
        <li className="mb-1">
          ...
          <div className="collapse" id="category2-collapse">
            <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
              <li><NavLink exact to="/category2" className="link-dark rounded"> sub category 1</NavLink></li>
              <li><NavLink exact to="/category2/sub" className="link-dark rounded"> sub category 2</NavLink></li>
            </ul>
          </div>
        </li>
        <li className="mb-1">
          ...
          <div className="collapse" id="category3-collapse">
            <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
              <li><NavLink exact to="/category3" className="link-dark rounded"> sub category 1</NavLink></li>
            </ul>
          </div>
        </li>
        <li className="border-top my-3"></li>
